...
const barHeights = wavePattern

const platforms = [
  { name: 'Google Meet', img: '/logos/google-meet.svg' },
  { name: 'Zoom',        img: '/logos/zoom.svg' },
  { name: 'MS Teams',    img: '/logos/teams.svg' },
  { name: 'YouTube',     img: '/logos/youtube.svg' },
  { name: 'Spotify',     img: '/logos/spotify.svg' },
]
</script>
